Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "52aaeb4786140c2b7bc153235e9f472da556eef9"}

  s.subspec 'Core' do |cx|
    cx.source_files = 'VSContent/SwiftSource/Core/2.5.0/**/*'
    cx.exclude_files = 'VSContent/SwiftSource/Core/2.5.0/README.md'
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.8.0/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.8.0/README.md'
    epub.resources = [
