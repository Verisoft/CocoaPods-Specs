Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "b306d5ad61e163c423d8ba0cbb1d0b38412b3c71"}
  ...
  s.subspec 'Epub' do |epub|
    ...
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.2.1/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'Audio' do |audio|
    audio.source_files = 'VSContent/SwiftSource/ContentAudio/2.2.2/**/*'
