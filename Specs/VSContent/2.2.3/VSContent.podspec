Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "fc497394b9d77d5bccaf8044c443b9ee8c152d88"}
  ...
  s.subspec 'Epub' do |epub|
    ...
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.2.1/**/*.{js,css,storyboard,xib}',
    ]
