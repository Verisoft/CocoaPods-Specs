Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "28e785fea375a25e15d0ab700023b3045672fa97"}
  ...
  s.subspec 'Epub' do |epub|
    ...
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.2.1/**/*.{js,css,html}',
    ]
