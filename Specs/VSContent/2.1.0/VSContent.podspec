Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "8aa13b17e46790676ac2580aa19be6a959bf3cb6"}
  ...
  s.subspec 'Epub' do |epub|
    ...
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.0.0/**/*.{js,css,storyboard}',
    ]
