Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "6baf939a822a4a6e87d91550e9d5cda84da8f043"}

  s.subspec 'Core' do |cx|
    cx.source_files = 'VSContent/SwiftSource/Core/2.4.8/**/*'
    cx.exclude_files = 'VSContent/SwiftSource/Core/2.4.8/README.md'
