Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "90b47734476fa69c7789e2acfa01f72557507503"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.4.2/**/*.{swift}'
    epub.exclude_files = 'README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.4.2/**/*.{js,css,html,storyboard,xib}',
    ]
