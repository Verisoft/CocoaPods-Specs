Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "7a806d9a93bc53e0fd50bae5f8335d766a6970c2"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.7.2/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.7.2/README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.7.2/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'Audio' do |audio|
    audio.source_files = 'VSContent/SwiftSource/ContentAudio/2.3.12/**/*'
    audio.exclude_files = 'VSContent/SwiftSource/ContentAudio/2.3.12/README.md'
