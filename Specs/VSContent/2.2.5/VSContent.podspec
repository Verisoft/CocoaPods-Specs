Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "9f8537b65d7ac035fc35ff3d06ddcaf615e43a42"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.2.2/**/*.{swift}'
    epub.exclude_files = 'README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.2.2/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'HTML' do |html|
    ...
    html.resources = [
    'VSContent/SwiftSource/ContentHTML/2.1.1/**/*.{js,css, html}',
    ]    
  ...
  s.subspec 'PPT' do |ppt|
    ppt.source_files = 'VSContent/SwiftSource/ContentPPT/2.2.2/**/*'
  ...
  s.subspec 'PDF' do |pdf|
    pdf.source_files = 'VSContent/SwiftSource/ContentPDF/2.3.0/**/*'
  ...
  s.subspec 'Video' do |video|
    video.source_files = 'VSContent/SwiftSource/ContentVideo/2.2.4/**/*'
  ...
  s.subspec 'Quiz' do |quiz|
    quiz.source_files = 'VSContent/SwiftSource/ContentQuiz/2.1.3/**/*'
    quiz.exclude_files = 'README.md'
    quiz.resources = [
    'VSContent/SwiftSource/ContentQuiz/2.1.3/**/*.{html,js,css,json,map}',
    ]
  ...
  s.subspec 'Audio' do |audio|
    audio.source_files = 'VSContent/SwiftSource/ContentAudio/2.2.4/**/*'
  ...
  s.subspec 'Subscription' do |sub|
    sub.source_files = 'VSContent/SwiftSource/Subscription/2.1.5/**/*'
