Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "893e79f98642ba0948fc0aa681e6d343ae3be0d5"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.2.3/**/*.{swift}'
    epub.exclude_files = 'README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.2.3/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'Quiz' do |quiz|
    ...
    quiz.resources = [
    'VSContent/SwiftSource/ContentQuiz/2.1.2/**/*.{html,js,css,json,map}',
    ]
