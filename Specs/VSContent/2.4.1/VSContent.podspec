Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "8ec2dad8d40209b0a013c45933c9833489fc53fd"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.6.0/**/*.{swift}'
    epub.exclude_files = 'README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.6.0/**/*.{js,css,html,storyboard,xib}',
    ]
