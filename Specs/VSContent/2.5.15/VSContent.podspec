Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "d61c4b3618cb9fd01c36e14a549d4788b3309a77"}

  s.subspec 'Core' do |cx|
    cx.source_files = 'VSContent/SwiftSource/Core/2.4.10/**/*'
    cx.exclude_files = 'VSContent/SwiftSource/Core/2.4.10/README.md'
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.7.1/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.7.1/README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.7.1/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'PDF' do |pdf|
    pdf.source_files = 'VSContent/SwiftSource/ContentPDF/2.5.10/**/*'
    pdf.exclude_files = 'VSContent/SwiftSource/ContentPDF/2.5.10/README.md'
  ...
  s.subspec 'Audio' do |audio|
    audio.source_files = 'VSContent/SwiftSource/ContentAudio/2.3.11/**/*'
    audio.exclude_files = 'VSContent/SwiftSource/ContentAudio/2.3.11/README.md'
  ...
  s.subspec 'Subscription' do |subsc|
    subsc.source_files = 'VSContent/SwiftSource/Subscription/2.3.4/**/*'
    subsc.exclude_files = 'VSContent/SwiftSource/Subscription/2.3.4/README.md'
