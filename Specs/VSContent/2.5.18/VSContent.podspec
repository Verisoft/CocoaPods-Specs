Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "762057ed1eaa34e3b6f6e04821694a1245eb4f8c"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.7.4/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.7.4/README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.7.4/**/*.{js,css,html,storyboard,xib}',
    ]
