Pod::Spec.new do |s|
  ...
  s.source       = {:git => "https://github.com/Verisoft/CocoaPods-Source.git", :commit => "5ebd47b2dd1b3135ddece4d1c475fe13f8bc75ca"}
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.7.0/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.7.0/README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.7.0/**/*.{js,css,html,storyboard,xib}',
    ]
