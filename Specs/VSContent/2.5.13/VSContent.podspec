Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |cx|
    cx.source_files = 'VSContent/SwiftSource/Core/2.4.9/**/*'
    cx.exclude_files = 'VSContent/SwiftSource/Core/2.4.9/README.md'
  ...
  s.subspec 'Epub' do |epub|
    epub.source_files = 'VSContent/SwiftSource/ContentEpub/2.6.8/**/*.{swift}'
    epub.exclude_files = 'VSContent/SwiftSource/ContentEpub/2.6.8/README.md'
    epub.resources = [
    'VSContent/SwiftSource/ContentEpub/2.6.8/**/*.{js,css,html,storyboard,xib}',
    ]
  ...
  s.subspec 'PDF' do |pdf|
    pdf.source_files = 'VSContent/SwiftSource/ContentPDF/2.5.9/**/*'
    pdf.exclude_files = 'VSContent/SwiftSource/ContentPDF/2.5.9/README.md'
