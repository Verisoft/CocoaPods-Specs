Pod::Spec.new do |spec|
  ...
  spec.summary      = 'Default Signature flow for Verisoft products. WARNING: 1.3.1 adds displayName attribute on CoreData.'
  spec.source       = {:git => 'https://github.com/Verisoft/CocoaPods-Source.git'}
  spec.source_files = 'VSSignature/Source/1.3.1/*'
